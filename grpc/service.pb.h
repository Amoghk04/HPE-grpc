...
PROTOBUF_NAMESPACE_OPEN
template<> ::myservice::FileDownloadRequest* Arena::CreateMaybeMessage<::myservice::FileDownloadRequest>(Arena*);
template<> ::myservice::FileDownloadResponse* Arena::CreateMaybeMessage<::myservice::FileDownloadResponse>(Arena*);
template<> ::myservice::FileUploadRequest* Arena::CreateMaybeMessage<::myservice::FileUploadRequest>(Arena*);
template<> ::myservice::FileUploadResponse* Arena::CreateMaybeMessage<::myservice::FileUploadResponse>(Arena*);
...
class FileUploadRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:myservice.FileUploadRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "myservice.FileUploadRequest";
  }
  protected:
...
class FileUploadResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:myservice.FileUploadResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "myservice.FileUploadResponse";
  }
  protected:
...
class FileDownloadRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:myservice.FileDownloadRequest) */ {
 public:
  inline FileDownloadRequest() : FileDownloadRequest(nullptr) {}
  ~FileDownloadRequest() override;
  explicit PROTOBUF_CONSTEXPR FileDownloadRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "myservice.FileDownloadRequest";
  }
  protected:
...
class FileDownloadResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:myservice.FileDownloadResponse) */ {
 public:
  inline FileDownloadResponse() : FileDownloadResponse(nullptr) {}
  ~FileDownloadResponse() override;
  explicit PROTOBUF_CONSTEXPR FileDownloadResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "myservice.FileDownloadResponse";
  }
  protected:
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void FileUploadResponse::set_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:myservice.FileUploadResponse.message)
}
inline std::string* FileUploadResponse::mutable_message() {
  std::string* _s = _internal_mutable_message();
...
inline void FileUploadResponse::set_allocated_message(std::string* message) {
  if (message != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void FileDownloadResponse::set_content(ArgT0&& arg0, ArgT... args) {
 
 _impl_.content_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:myservice.FileDownloadResponse.content)
}
inline std::string* FileDownloadResponse::mutable_content() {
  std::string* _s = _internal_mutable_content();
...
inline void FileDownloadResponse::set_allocated_content(std::string* content) {
  if (content != nullptr) {
